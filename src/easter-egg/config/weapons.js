...
export const WEAPONS = {
  ...
  luzmala: {
    name: 'Mate del Chiquitijuein',
    desc: 'Se arma en el altillo. Suelta luces malas que buscan solas a los muertos y revientan.',
    kind: 'wisp',
    auto: false,
    rpm: 140,
    mag: 8,
    ...
    pap: { name: 'Mate del Chiquitijuein Eterno', mag: 12, reserve: 120, wisp: { count: 5, speed: 14, turn: 7, radius: 3.4, damage: 6500, life: 5.5 } },
  },
  oro: {
